        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark">{{ __('room') }}</span>
                </h3>
                <div class="card-toolbar">
                    <a class="btn btn-success font-weight-bolder font-size-sm" data-toggle="modal" data-target="#createModal">
                        <span class="svg-icon svg-icon-md svg-icon-white">
                            <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Communication/Add-room.svg--><svg
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">{{ __('Create room') }}</h5>
                                    ...
                                    <form class="form" action="{{ route('room.store') }}" method="post"
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                <input class="@error('number') is-invalid @enderror form-control"
                                        ...
                                        <div class="form-group ">
                                            <label>{{ __('size') }}</label>
                                            <div class="input-group">
                                                <input class="@error('size') is-invalid @enderror form-control"
                    ...
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        <thead>
                            <tr class="text-uppercase">
                                ...
                                <th style="min-width: 250px">{{ __('number') }}</th>
                                <th style="min-width: 250px">{{ __('name') }}</th>
                                <th style="min-width: 250px">{{ __('size') }}</th>
                        ...
                        <tbody>
                            @forelse($rooms as $room)
                                <tr>
                                    <td class="pl-0 py-8">{{ $room->id }}</td>
                                    <td class="pl-0 py-8">{{ $room->number }}</td>
                                    <td class="pl-0 py-8">{{ $room->name }}</td>
                                    <td class="pl-0 py-8">{{ $room->size }}</td>
                                    ...
                                    <td class="pr-0 ">
                                        ...
                                        <div class="modal fade " id="editModal{{ $room->id }}" role="dialog"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">
                                                            {{ __('update room') }} - {{ $room->name }}</h5>
                                        ...
                                        {{-- DELETE --}}
                                        {{-- @can('delete rooms') --}}
                                        <form class="d-inline-block" action="{{ route('room.destroy', $room) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
